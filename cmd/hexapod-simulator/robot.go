...
func (ctrl *Controller) readInput() {
	if rl.IsGamepadAvailable(0) {
		leftX := rl.GetGamepadAxisMovement(0, rl.GamepadXboxAxisLeftX)
		leftY := rl.GetGamepadAxisMovement(0, rl.GamepadXboxAxisLeftY)

		rightX := rl.GetGamepadAxisMovement(0, rl.GamepadXboxAxisRightX)
		rightY := rl.GetGamepadAxisMovement(0, rl.GamepadXboxAxisRightY)

		rightTrigger := rl.GetGamepadAxisMovement(0, rl.GamepadXboxAxisRt)
